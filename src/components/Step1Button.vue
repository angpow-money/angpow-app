...
<div class="w-full relative flex justify-end items-end">
    ...
    <div class="absolute bottom-[0dvh] flex justify-center items-center w-full">
        <div :class="[expand?'max-h-[70dvh] ':'max-h-[64px]']"  class="w-full bg-black text-white rounded-xl max-h-full m-0 text-xl font-semibold transition-all duration-500 h-[70vh] flex flex-col justify-end items-end">
